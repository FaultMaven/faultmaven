...
fm-personal-tenant retire --subject user_01H... --apply       # Retire a JIT personal tenant (both halves + WorkOS); --next-login refuse|fresh-tenant, dry run by default (#1045 D8)
