...
down_revision: Union[str, Sequence[str], None] = '0a6eafc2e4cf'
...
def upgrade() -> None:
    ...
    if "conversion_jobs" not in existing_tables:
        op.create_table(
            ...
            sa.Column('source_type', sa.String(length=20), nullable=False, server_default='document'),
            sa.Column('case_id', sa.String(length=36), nullable=True),
            sa.Column('failure_modes_detected', sa.Integer(), nullable=False, server_default='0'),
    ...
    if "conversion_drafts" not in existing_tables:
        op.create_table(
            ...
            sa.Column('source_type', sa.String(length=20), nullable=False, server_default='document'),
            sa.Column('validation_passed', sa.Boolean(), nullable=False, server_default='1'),
        ...
        if 'source_type' not in existing_cols:
            op.add_column('conversion_drafts',
                sa.Column('source_type', sa.String(length=20), nullable=False, server_default='document'))
