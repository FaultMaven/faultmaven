...
- **Hypotheses** have a lifecycle: CAPTURED → ACTIVE → VALIDATED / REFUTED / RETIRED, with confidence decay (×0.85 per stagnant turn; causally supported, uncontradicted hypotheses are not aged by time)
