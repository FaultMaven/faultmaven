...
- Authorization pattern: `JOIN cases c ON c.case_id = child.case_id WHERE c.organization_id = :organization_id`
...
- **Query Pattern**: 0% of child queries filter by organization_id without case_id (analyzed 369 queries)
