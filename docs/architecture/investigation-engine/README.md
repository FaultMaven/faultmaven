...
- **[Evidence Needs Design](./evidence-needs-design.md)** — Demand-side pool of outstanding data asks: creation triggers, lifecycle, engine backstop, context block, suggestion linkage. §11 is the as-built map (file:line, metrics, wire seam) for debugging the shipped feature.
