...
> The unified opportunistic flow (formerly proposed as "Investigation Flow Redesign") shipped 2026-06-05 and is folded into [Investigation Lifecycle Logic §2](./investigation-lifecycle-logic.md#2-stabilization-as-an-insert) — design rationale, assessment-vs-gate variables, and resolved decisions (§2.5) included.
