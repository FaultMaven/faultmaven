...
| `ACTIVE` → `RETIRED` | Anchoring prevention — too many hypotheses in one category, low progress | **System-automated** (`hypothesis_manager.py`, `force_alternative_generation`, retires the lowest-progress members of the over-represented category) |
