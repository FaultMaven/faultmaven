...
from faultmaven.api.v1.dependencies import get_agent_service_refactored
from faultmaven.services.agent_service_refactored import AgentServiceRefactored
from faultmaven.infrastructure.observability.tracing import trace

router = APIRouter(prefix="/query", tags=["query_processing_refactored"])

logger = logging.getLogger(__name__)


@router.post("/troubleshoot", response_model=TroubleshootingResponse)
@trace("api_troubleshoot_refactored")
async def troubleshoot(
    request: QueryRequest,
    agent_service: AgentServiceRefactored = Depends(get_agent_service_refactored)
...
@trace("api_get_investigation_refactored")
...
@trace("api_list_session_investigations_refactored")
...
@router.get("/health")
@trace("api_agent_health_refactored")
