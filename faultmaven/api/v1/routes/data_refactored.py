...
from faultmaven.api.v1.dependencies import get_data_service_refactored
from faultmaven.services.data_service_refactored import DataServiceRefactored
from faultmaven.infrastructure.observability.tracing import trace

router = APIRouter(prefix="/data", tags=["data_processing_refactored"])
...
@trace("api_upload_data_refactored")
async def upload_data(
    file: UploadFile = File(...),
    session_id: str = Form(...),
    description: Optional[str] = Form(None),
    data_service: DataServiceRefactored = Depends(get_data_service_refactored)
) -> UploadedData:
    """
...
@trace("api_batch_upload_data_refactored")
...
@trace("api_analyze_data_refactored")
...
@trace("api_get_session_data_refactored")
...
@trace("api_delete_data_refactored")
...
@router.get("/health")
@trace("api_data_health_refactored")
