...
class PerformanceMonitoringStartup:
    ...
    async def initialize_performance_monitoring(self) -> Dict[str, Any]:
        ...
        try:
            ...
            await self._start_analytics_dashboard_service(
                di_container, initialization_status
            )

            # 4. Start Performance Optimization Service background processing
            await self._start_performance_optimization_service(
                di_container, initialization_status
            )
            ...
            initialization_status.update(
                {
                    ...
                    "services_initialized": self.startup_metrics[
                        "services_initialized"
                    ],
                    "services_started": self.startup_metrics["services_started"],
                    "background_tasks_started": self.startup_metrics[
            ...
            self.logger.error(
                f"Critical error during performance monitoring initialization: {e}"
            )
            return {
    ...
    async def _start_metrics_collector(self, di_container, status: Dict[str, Any]):
        ...
        try:
            ...
            if metrics_collector:
                ...
                self.logger.info(
                    "✅ Metrics Collector initialized and background processing started"
                )
            else:
                status["services"]["metrics_collector"] = {
                ...
                self.startup_metrics["startup_errors"].append(
    ...
    async def _start_intelligent_cache(self, di_container, status: Dict[str, Any]):
        ...
        try:
            ...
            if intelligent_cache:
                ...
                self.logger.info(
                    "✅ Intelligent Cache initialized and background processing started"
                )
            else:
                status["services"]["intelligent_cache"] = {
                    "status": "not_available",
                ...
                self.startup_metrics["startup_errors"].append(
                    "Intelligent cache not available"
                )
    ...
    async def _start_analytics_dashboard_service(
        ...
        try:
            ...
            if analytics_service:
                ...
                self.logger.info(
                    "✅ Analytics Dashboard Service initialized and background processing started"
                )
            else:
                status["services"]["analytics_dashboard_service"] = {
                    "status": "not_available",
                ...
                self.startup_metrics["startup_errors"].append(
                    "Analytics dashboard service not available"
                )
            ...
            self.startup_metrics["startup_errors"].append(
                f"Analytics Dashboard Service: {str(e)}"
            )
    ...
    async def _start_performance_optimization_service(
        ...
        try:
            ...
            if optimization_service:
                ...
                self.logger.info(
                    "✅ Performance Optimization Service initialized and background processing started"
                )
            else:
                status["services"]["performance_optimization_service"] = {
                    "status": "not_available",
                ...
                self.startup_metrics["startup_errors"].append(
                    "Performance optimization service not available"
                )
    ...
    async def shutdown_performance_monitoring(self) -> Dict[str, Any]:
        ...
        try:
            ...
            await self._shutdown_performance_optimization_service(
                di_container, shutdown_status
            )
            await self._shutdown_analytics_dashboard_service(
                di_container, shutdown_status
            )
...
async def on_shutdown():
    ...
    try:
        ...
        if shutdown_status["overall_status"] == "success":
            ...
            logger.warning(
                "⚠️ Performance Monitoring System shutdown completed with issues"
            )
