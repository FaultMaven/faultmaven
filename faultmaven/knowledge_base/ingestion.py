...
class KnowledgeIngester:
    ...
    async def _process_and_store(self, document: KnowledgeBaseDocument):
        ...
        self.logger.info(f"Stored {len(chunks)} chunks for document {document.document_id}")
    ...
    async def search(self, query: str, n_results: int = 5, filter_metadata: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        """
