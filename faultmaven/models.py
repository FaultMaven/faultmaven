...
class SessionContext(BaseModel):
    ...
    data_uploads: List[str] = Field(default_factory=list, description="List of uploaded data IDs")
    ...
    agent_state: Optional[AgentState] = Field(
        None, description="Current agent state"
    )
...
class DataInsightsResponse(BaseModel):
    ...
    insights: Dict[str, Any] = Field(..., description="Extracted insights from the data")
...
class KnowledgeBaseDocument(BaseModel):
    ...
    document_type: str = Field(..., description="Type of document (e.g., troubleshooting guide, FAQ)")
