...
class HypothesisStatus(str, Enum):
    ...
    VALIDATED = "validated"    # Confirmed by evidence (confidence ≥70% + ≥2 supporting evidence)
    REFUTED = "refuted"        # Disproved by evidence (confidence ≤20% + ≥2 refuting evidence)
...
class WorkingConclusion(BaseModel):
    ...
    # Action guidance
    can_proceed_with_solution: bool = Field(default=False, description="Confidence ≥ 70%")
...
class ProgressMetrics(BaseModel):
    ...
    hypotheses_with_sufficient_evidence: int = Field(default=0, description="Evidence completeness ≥ 70%")
