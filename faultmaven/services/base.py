...
class BaseService(ABC):
    ...
    def __init__(self, service_name: str | None = None):
        ...
        self.logger = get_unified_logger(
            f"faultmaven.services.{service_name}", "service"
        )
    ...
    async def execute_operation(
        ...
        **kwargs,
        ...
        async with self.logger.operation(
            operation_name, service=self.service_name
        ) as ctx:
            try:
    ...
    def log_metric(
        ...
        **extra_fields,
        ...
        self.logger.log_metric(
            metric_name=metric_name, value=value, unit=unit, tags=tags, **extra_fields
        )
    ...
    def log_operation(self, operation: str, **kwargs) -> None:
        ...
        """
        self.logger.info(operation, extra={"service": self.service_name, **kwargs})
