...
class CaseConverter:
    ...
    def entity_to_api(case_entity: CaseEntity) -> CaseAPI:
        ...
        return CaseAPI(
            ...
            updated_at=(
                to_json_compatible(case_entity.updated_at)
                if hasattr(case_entity.updated_at, "isoformat")
                else str(
                    getattr(
                        case_entity,
                        "updated_at",
            ...
            session_id=getattr(case_entity, "metadata", {}).get(
                "session_id", None
    ...
    def summary_to_api(
        ...
        return CaseAPI(
            ...
            priority=(
                ...
                if hasattr(case_summary.priority, "value")
                else str(case_summary.priority)
            ),
            created_at=(
                to_json_compatible(case_summary.created_at)
                if hasattr(case_summary.created_at, "isoformat")
                else str(case_summary.created_at)
            ),
            updated_at=(
                to_json_compatible(case_summary.updated_at)
                if hasattr(case_summary.updated_at, "isoformat")
                else str(case_summary.updated_at)
            ),
