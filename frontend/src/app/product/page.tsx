    ...
    <main>
      ...
      <section className="py-20 text-center bg-white dark:bg-slate-900">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mt-6 text-xl text-slate-600 dark:text-slate-400 space-y-4 max-w-3xl mx-auto">
            <p>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800/50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50">How You Interact with FaultMaven 1.0: A Seamless Experience</h2>
          ...
          <div className="mt-16 space-y-12">
            <div>
              <h3 className="text-2xl font-semibold text-slate-800 dark:text-slate-200">Your Command Center: The Browser Extension & Side-Panel</h3>
              <p className="mt-3 text-lg text-slate-600 dark:text-slate-400">At the heart of FaultMaven 1.0 is a lightweight browser extension. Once installed, it provides an always-accessible and adjustable side-panel right in your browser. This means your AI Copilot is ready to assist whenever and wherever your work takes you—whether you&apos;re examining monitoring dashboards, reviewing deployment pipelines, sifting through logs in a web interface, analyzing a discussion in a Slack channel (when viewed in your browser), reviewing details in a ServiceNow incident report, or reading technical documentation. With FaultMaven by your side, there&apos;s less need to constantly switch contexts or juggle separate, heavy applications.</p>
              <div className="mt-8">
                <Image 
                  src={sidepanelImage}
                  alt="FaultMaven AI Copilot side-panel interaction"
                  placeholder="blur"
                  className="rounded-lg shadow-xl ring-1 ring-slate-200 dark:ring-slate-800"
                />
              </div>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-slate-800 dark:text-slate-200">Flexible Data Input – You&apos;re in Control:</h3>
              <p className="mt-3 text-lg text-slate-600 dark:text-slate-400">FaultMaven 1.0 works with the specific context you provide, ensuring its analysis is targeted and relevant to the problem at hand. You control the information flow with simple, direct methods:</p>
              <ul className="mt-4 list-disc list-inside space-y-3 text-lg text-slate-600 dark:text-slate-400">
                <li><strong className="font-bold text-slate-700 dark:text-slate-300">Copy & Paste:</strong> Easily paste error messages, log snippets (from development or production systems), code excerpts, configuration details, or any relevant text directly into the side-panel.</li>
                <li><strong className="font-bold text-slate-700 dark:text-slate-300">File Upload:</strong> Securely upload various text-based files such as full log files, configuration files, exported metrics data, or system reports for FaultMaven to analyze.</li>
                <li><strong className="font-bold text-slate-700 dark:text-slate-300">Share Page Context:</strong> With your permission, share the textual content of your current browser page for broader situational awareness. This is ideal for capturing information from web-based tools like monitoring dashboards, internal wikis, or even displayed Slack messages and discussion threads (when using Slack in your browser).</li>
              </ul>
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">This user-driven data input for 1.0 means no direct system integrations are needed to get started, allowing for rapid adoption and immediate use.</p>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-slate-800 dark:text-slate-200">An Evolving Dialogue with Your AI Copilot:</h3>
              <p className="mt-3 text-lg text-slate-600 dark:text-slate-400">Interacting with FaultMaven isn&apos;t about one-shot queries and static answers. It&apos;s a dynamic, continuous conversation. You can ask initial questions, provide data, and based on FaultMaven&apos;s insights and suggestions, ask follow-up questions, request further analysis, or explore different hypotheses. Your AI Copilot provides evolving guidance, helping you navigate the diagnostic process step-by-step as you delve deeper into the issue together. You steer the investigation; your AI Copilot illuminates the path.</p>
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">This seamless interaction model ensures that FaultMaven 1.0 acts as a true extension of your analytical capabilities, easy to engage with and immediately valuable from your first troubleshooting session.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white dark:bg-slate-900">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50">FaultMaven 1.0: Core Capabilities</h2>
          ...
          <div className="mt-16 space-y-12">
            <FeatureCard 
              icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-blue-600"><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.572L16.5 21.75l-.398-1.178a3.375 3.375 0 00-2.456-2.456L12.5 18l1.178-.398a3.375 3.375 0 002.456-2.456L16.5 14.25l.398 1.178a3.375 3.375 0 002.456 2.456L20.5 18l-1.178.398a3.375 3.375 0 00-2.456 2.456z" /></svg>}
              ...
              outcomes={
                <ul className="mt-2 list-disc list-inside space-y-1">
                  <li>Accelerated Analysis: Significantly reduces the time required to manually sift through and correlate data.</li>
                  <li>Root Cause Hypotheses: Generates potential root causes based on the provided data, offering a focused starting point for your investigation.</li>
                  <li>Guided Next Steps: Suggests logical follow-up actions (e.g., specific data to check, questions to ask) to structure the diagnostic process.</li>
                  <li>Reduced Cognitive Load: Offloads initial data processing and pattern recognition, allowing you to concentrate on higher-level problem-solving.</li>
                  <li>Improved MTTR: Aims to directly contribute to reducing Mean Time To Resolution by streamlining the diagnostic phase.</li>
                </ul>
              }
            />
            <FeatureCard 
              icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-blue-600"><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg>}
              ...
              outcomes={
                <ul className="mt-2 list-disc list-inside space-y-1">
                  <li>Time Savings: Reduces the manual effort and time typically spent on note-taking and summarizing complex information during or after troubleshooting.</li>
                  <li>Effective Knowledge Capture: Helps ensure that critical insights, observations, and resolution steps from your sessions are documented efficiently.</li>
                  <li>Improved Consistency: Can assist in standardizing the initial capture of information for follow-up reports or team knowledge sharing.</li>
                </ul>
              }
            />
            <FeatureCard 
              icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-blue-600"><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.18-3.182V6.345a2.25 2.25 0 00-2.25-2.25h-5.3c-1.24 0-2.25 1.01-2.25 2.25v3.185" /></svg>}
              ...
              outcomes={
                <ul className="mt-2 list-disc list-inside space-y-1">
                  <li>Avoids Redundant Work: Prevents the need to &apos;reinvent the wheel&apos; by quickly accessing previously successful solutions.</li>
                  <li>Consistent Application of Best Practices: Helps you apply your own proven methods and key learnings consistently.</li>
                  <li>Personalized Expertise On-Demand: Your AI Copilot becomes increasingly tailored to your specific knowledge and experience.</li>
                  <li>Faster Problem Solving: Reduces time spent searching for or trying to recall past solutions.</li>
                </ul>
              }
            />
          </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800/50">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50">Technology Highlights</h2>
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8">
            <TechHighlightCard 
              icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-blue-600"><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /></svg>}
            ...
            />
            <TechHighlightCard 
              icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-blue-600"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" /></svg>}
            ...
            />
            <TechHighlightCard 
              icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-blue-600"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" /></svg>}
          ...
          <p className="mt-8 text-center text-slate-600 dark:text-slate-400">
            FaultMaven&apos;s technology is purposefully designed to deliver practical, reliable, and insightful assistance, helping you cut through complexity and resolve issues faster.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8 max-w-3xl mx-auto text-left">
            <div className="p-8 border border-slate-200 dark:border-slate-800 rounded-lg bg-slate-50 dark:bg-slate-800/50 hover:bg-white hover:shadow-xl hover:border-slate-300 dark:hover:bg-slate-800 dark:hover:border-slate-700 transition-all duration-300">
              ...
              <a
                href="/design-partner-application"
                className="mt-6 inline-flex items-center justify-center px-6 py-2 text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 transition duration-200"
              >
