...
- [AWS EKS: Troubleshooting IAM](https://docs.aws.amazon.com/eks/latest/userguide/security-iam-troubleshoot.html) — IAM-specific EKS troubleshooting for role assumption and token generation failures.
