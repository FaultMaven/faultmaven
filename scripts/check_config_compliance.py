...
from tests.architecture.test_configuration_compliance import (
    ConfigurationViolationScanner,
)
...
def main():
    ...
    if legacy_violations:
        print(
            f"❌ Found {len(legacy_violations)} legacy configuration import violations:"
        )
    ...
    try:
        ...
        missing_headers = [
            ...
            if h not in cors_config.get("expose_headers", [])
        ]
