...
# The generation environment lives in its own side-effect-free module so the
# pinned-generator test can import the SAME values instead of hand-copying them
# (a stale copy would starve the test's baseline subprocess and turn its
# assertion into a permanent skip). See scripts/generation_environment.py.
