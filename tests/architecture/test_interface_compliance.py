...
def test_refactored_files_exist():
    """Test that refactored files were created"""
    import os
    
    expected_files = [
        "faultmaven/container_refactored.py",
        "faultmaven/api/v1/routes/agent_refactored.py", 
        "faultmaven/api/v1/routes/data_refactored.py",
        "faultmaven/services/agent_service_refactored.py",
        "faultmaven/services/data_service_refactored.py",
        "faultmaven/config/feature_flags.py",
    ]
    
    for file_path in expected_files:
        assert os.path.exists(file_path), f"Expected refactored file {file_path} should exist"
