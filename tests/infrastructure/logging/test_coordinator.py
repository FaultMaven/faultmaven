...
class TestLoggingCoordinator:
    ...
    async def test_log_once_prevents_duplicate_logging(self):
        ...
        LoggingCoordinator.log_once(
            "test_op", mock_logger, "info", "Test message", extra_field="test"
        )
    ...
    def test_log_once_different_operations(self):
        ...
        LoggingCoordinator.log_once("operation1", mock_logger, "info", "Message 1")

        LoggingCoordinator.log_once("operation2", mock_logger, "info", "Message 2")
    ...
    def test_log_once_without_context(self):
        ...
        LoggingCoordinator.log_once("test_op", mock_logger, "info", "Test message")

        LoggingCoordinator.log_once(
            "test_op", mock_logger, "info", "Test message duplicate"
        )
    ...
    def test_log_once_different_log_levels(self):
        ...
        LoggingCoordinator.log_once(
            "warn_op", mock_logger, "warning", "Warning message"
        )
        LoggingCoordinator.log_once("error_op", mock_logger, "error", "Error message")
        LoggingCoordinator.log_once(
            "crit_op", mock_logger, "critical", "Critical message"
        )
    ...
    def test_log_once_invalid_level_fallback(self):
        ...
        LoggingCoordinator.log_once(
            "test_op", mock_logger, "invalid_level", "Test message"
        )
