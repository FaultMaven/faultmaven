...
class TestUnifiedLogger:
    ...
    def test_log_boundary_without_context(self):
        ...
        self.unified_logger.log_boundary(
            operation="test_operation", direction="inbound", data={"key": "value"}
        )
    ...
    def test_log_boundary_payload_info(self):
        ...
        test_data = {"key1": "value1", "key2": "value2", "nested": {"inner": "value"}}

        self.unified_logger.log_boundary(
            operation="test_op", direction="inbound", data=test_data
        )
    ...
    async def test_operation_context_manager_success(self):
        ...
        async with self.unified_logger.operation(
            "test_operation", user_id="123"
        ) as ctx:
    ...
    def test_basic_log_methods(self):
        ...
        self.mock_logger.debug.assert_called_once_with(
            "Debug message", layer="service", extra_field="debug_value"
        )

        # Test info
        self.unified_logger.info("Info message", context="test")
        self.mock_logger.info.assert_called_with(
            "Info message", layer="service", context="test"
        )

        # Test warning
        self.unified_logger.warning("Warning message")
        self.mock_logger.warning.assert_called_with("Warning message", layer="service")
