...
class TestSessionStatus:
    ...
    def test_all_statuses_defined(self):
        """Verify all expected session statuses are defined."""
        expected_statuses = [
            "active",
            "paused",
            "completed",
...
class TestInvestigationSessionCreation:
    """Tests for InvestigationSession creation and validation."""
    ...
    def test_create_minimal_session(self):
        ...
        assert session.session_id == "sess_123abc"
        assert session.case_id == "case_456def"
        assert session.user_id == "user_789"
        assert session.organization_id == "org_012"
        ...
        assert session.token_budget_limit is None
    ...
    def test_create_full_session(self):
        ...
        session = InvestigationSession(
            ...
            total_duration_ms=3599000,
            session_goal="Identify root cause of timeout",
            findings_summary="Root cause was database connection pool exhaustion",
