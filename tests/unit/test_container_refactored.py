...
class TestDIContainer:
    ...
    def test_infrastructure_layer_creation(self):
        ...
        from faultmaven.container_refactored import INTERFACES_AVAILABLE
    ...
    @patch('faultmaven.container_refactored.logging')
    def test_initialization_error_handling(self, mock_logging):
        ...
        with patch('faultmaven.container_refactored.INTERFACES_AVAILABLE', True):
    ...
    @patch('faultmaven.services.agent_service_refactored.AgentServiceRefactored')
    def test_dependency_injection_flow(self, mock_agent_service):
        ...
        # Verify AgentServiceRefactored was called with proper dependencies
    ...
    def test_global_container_instance(self):
        ...
        from faultmaven.container_refactored import container as global_container
