"""Comprehensive test suite for KnowledgeServiceRefactored - Phase 3 Testing

This test module validates the refactored KnowledgeService which uses interface-based
...
class TestKnowledgeServiceRefactored:
    """Comprehensive test suite for KnowledgeServiceRefactored"""
    ...
    def knowledge_service(
        ...
        """KnowledgeServiceRefactored instance with mocked dependencies"""
        return KnowledgeServiceRefactored(
...
4. Check network connectivity
    ...
    async def test_ingest_document_without_vector_store(
        ...
        service = KnowledgeServiceRefactored(
            knowledge_ingester=mock_knowledge_ingester,
            sanitizer=mock_sanitizer,
            tracer=mock_tracer,
